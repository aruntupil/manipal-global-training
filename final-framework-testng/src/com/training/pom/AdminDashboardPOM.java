...
*/
	...
	public void clickCatalogCategory()
	{
		try {
			...
			Actions menuAction = new Actions(driver);
			WebElement loginMenu = driver.findElement(By.xpath("//*[@id='menu-catalog']/a"));
			menuAction.moveToElement(loginMenu).build().perform();
			menuAction.moveToElement(driver.findElement(By.xpath("//*[@id='menu-catalog']//ul/li/a"))).click().build().perform();
			
		}
		catch (Exception e){System.out.println("Error on click category");
		}
	}
